...
for seed in 12345 23451 34512 45123 51234; do
    echo "Running DIRECTPEBBLE with seed ${seed}"
    train \
        preset=direct_pebble/quadruped_walk \
        ...
        'logging.tags=[direct_pebble, baseline]' \
        "logging.group=direct_pebble/baseline" &
done

wait
echo "All DIRECTPEBBLE runs have completed."
