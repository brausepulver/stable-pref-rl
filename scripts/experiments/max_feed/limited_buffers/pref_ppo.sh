...
for max_feed in 500 1000 1500; do
    for i in $(seq 1 $N_RUNS); do
        ...
        outb stage uv run train \
            ...
            "logging.tags=[pref_ppo, experiment, disagreement, ann_buffer_size_eps, feed_buffer_size, max_feed]" \
            "logging.group=pref_ppo/ann_buf_size/disagreement/${ann_buffer_size_eps}/${feed_buffer_size}/max_feed_${max_feed}"
    done
done
