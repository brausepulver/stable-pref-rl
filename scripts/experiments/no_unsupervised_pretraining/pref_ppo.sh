...
BASE_PARAMS=(
    ...
    "preset.method.unsuper.n_steps_unsuper=null"
...
for i in $(seq 1 8); do
    ...
    train \
        ...
        'logging.tags=[pref_ppo, experiment, uniform]' \
        "logging.group=pref_ppo/no-unsuper/uniform" &
done
wait
...
for i in $(seq 1 8); do
    ...
    train \
        ...
        'logging.tags=[pref_ppo, experiment, disagreement]' \
        "logging.group=pref_ppo/no-unsuper/disagreement" &
done
wait
...
for i in $(seq 1 8); do
    ...
    train \
        ...
        "logging.group=pref_ppo/no-unsuper/entropy" &
done
wait
