...
BASE_PARAMS=(
    ...
    "+preset.method.pref.keep_all_eps=true"
)
...
for i in $(seq 1 $N_RUNS); do
    ...
    outb stage uv run train \
        ...
        "+preset.method.pref.synth_schedule.n_steps_first_train=352000" \
        "+preset.method.pref.synth_schedule.n_steps_last_train=1000000" \
        "preset.method.pref.synth_kwargs.neg_eps_until_steps=320000" \
        "preset.method.pref.synth_kwargs.pos_eps_after_eq_steps=32000" \
        'logging.tags=[pref_ppo,experiment,synthetic,disagreement]' \
        "logging.group=pref_ppo/experiment/synth/eph_2"
done
